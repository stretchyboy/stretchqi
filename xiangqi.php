  ...
  class xiangqi
  {
    ...
    function reset()
    {
      $this->redPieces[0]  = new PieceInfo("chariot",  "Red", new Position(9, 0));
			...
			$this->redPieces[4]  = new PieceInfo("king",     "Red", new Position(9, 4));
      ...
      {
	        	$this->redPieces[11 + $pawn] = new PieceInfo("pawn", "Red", new Position(6, 2*$pawn));
			}
			...
			$this->blackPieces[4]  = new PieceInfo("king",     "Black", new Position(0, 4));
      ...
      for ($pawn = 0; $pawn < 5; $pawn++)
      {
          $this->blackPieces[11 + $pawn] = new PieceInfo("pawn", "Black", new Position(3, 2*$pawn));
      }
	    ...
	    $this->pieceMap = array();
			...
			for ($pawn = 0; $pawn < 5; $pawn++)
			{
	        	$this->pieceMap[3][2*$pawn] = $this->blackPieces[11 + $pawn];
			}
			...
			for($pawn = 0; $pawn < 5; $pawn++)
			{
	        	$this->pieceMap[6][2*$pawn] = $this->redPieces[11 + $pawn];
	  	}
